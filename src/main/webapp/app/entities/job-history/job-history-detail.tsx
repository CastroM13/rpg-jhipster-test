    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobHistoryDetailsHeading">
          <Translate contentKey="rpgJhipsterTestApp.jobHistory.detail.title">JobHistory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="startDate">
              <Translate contentKey="rpgJhipsterTestApp.jobHistory.startDate">Start Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="endDate">
              <Translate contentKey="rpgJhipsterTestApp.jobHistory.endDate">End Date</Translate>
            </span>
          </dt>
          <dd>{jobHistoryEntity.endDate ? <TextFormat value={jobHistoryEntity.endDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="language">
              <Translate contentKey="rpgJhipsterTestApp.jobHistory.language">Language</Translate>
            </span>
          </dt>
          <dd>{jobHistoryEntity.language}</dd>
          <dt>
            <Translate contentKey="rpgJhipsterTestApp.jobHistory.job">Job</Translate>
          </dt>
          <dd>{jobHistoryEntity.job ? jobHistoryEntity.job.id : ''}</dd>
          <dt>
            <Translate contentKey="rpgJhipsterTestApp.jobHistory.department">Department</Translate>
          </dt>
          <dd>{jobHistoryEntity.department ? jobHistoryEntity.department.id : ''}</dd>
          <dt>
            <Translate contentKey="rpgJhipsterTestApp.jobHistory.employee">Employee</Translate>
          </dt>
