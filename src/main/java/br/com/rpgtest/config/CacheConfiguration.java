...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.rpgtest.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.rpgtest.repository.UserRepository.USERS_BY_EMAIL_CACHE);
