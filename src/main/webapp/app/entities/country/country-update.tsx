  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rpgJhipsterTestApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="rpgJhipsterTestApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rpgJhipsterTestApp.country.countryName')}
              ...
              <ValidatedField
                ...
                name="regionId"
                data-cy="region"
                label={translate('rpgJhipsterTestApp.country.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
