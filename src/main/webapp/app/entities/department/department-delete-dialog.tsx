...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rpgJhipsterTestApp.department.delete.question">
        <Translate contentKey="rpgJhipsterTestApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
