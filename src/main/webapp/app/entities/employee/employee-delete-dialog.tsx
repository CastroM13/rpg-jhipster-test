...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rpgJhipsterTestApp.employee.delete.question">
        <Translate contentKey="rpgJhipsterTestApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
