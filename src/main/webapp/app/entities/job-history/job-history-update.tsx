  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rpgJhipsterTestApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="rpgJhipsterTestApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rpgJhipsterTestApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.jobHistory.language')}
                id="job-history-language"
                name="language"
                data-cy="language"
                type="select"
              >
                <option value="FRENCH">{translate('rpgJhipsterTestApp.Language.FRENCH')}</option>
                <option value="ENGLISH">{translate('rpgJhipsterTestApp.Language.ENGLISH')}</option>
                <option value="SPANISH">{translate('rpgJhipsterTestApp.Language.SPANISH')}</option>
              </ValidatedField>
              <ValidatedField
                id="job-history-job"
                name="jobId"
                data-cy="job"
                label={translate('rpgJhipsterTestApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('rpgJhipsterTestApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employeeId"
                data-cy="employee"
                label={translate('rpgJhipsterTestApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
