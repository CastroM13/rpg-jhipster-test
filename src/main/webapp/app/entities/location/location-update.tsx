  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rpgJhipsterTestApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="rpgJhipsterTestApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rpgJhipsterTestApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="countryId"
                data-cy="country"
                label={translate('rpgJhipsterTestApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
