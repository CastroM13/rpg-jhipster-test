  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rpgJhipsterTestApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="rpgJhipsterTestApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('rpgJhipsterTestApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="managerId"
                data-cy="manager"
                label={translate('rpgJhipsterTestApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('rpgJhipsterTestApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
