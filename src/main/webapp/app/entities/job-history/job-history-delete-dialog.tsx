...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rpgJhipsterTestApp.jobHistory.delete.question">
        <Translate contentKey="rpgJhipsterTestApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
