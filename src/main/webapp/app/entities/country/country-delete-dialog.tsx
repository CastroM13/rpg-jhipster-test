...
export const CountryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rpgJhipsterTestApp.country.delete.question">
        <Translate contentKey="rpgJhipsterTestApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
