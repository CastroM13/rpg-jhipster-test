...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rpgJhipsterTestApp.location.delete.question">
        <Translate contentKey="rpgJhipsterTestApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
